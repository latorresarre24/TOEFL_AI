...
def grades():
    """Show index"""
    points1 = db.execute("SELECT avg(points) as avg_points FROM grades where user_id = ? and exam_id = 1;", session["user_id"])[0]["avg_points"]
    points2 = db.execute("SELECT avg(points) as avg_points FROM grades where user_id = ? and exam_id = 2;", session["user_id"])[0]["avg_points"]
    points3 = db.execute("SELECT avg(points) as avg_points FROM grades where user_id = ? and exam_id = 3;", session["user_id"])[0]["avg_points"]
    points4 = db.execute("SELECT avg(points) as avg_points FROM grades where user_id = ? and exam_id = 4;", session["user_id"])[0]["avg_points"]
